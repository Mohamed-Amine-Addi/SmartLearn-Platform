...
template <> constexpr inline auto quizwindow::qt_create_metaobjectdata<qt_meta_tag_ZN10quizwindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'quizFinished'
        QtMocHelpers::SignalData<void(const QuizResult &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
...
void quizwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->quizFinished((*reinterpret_cast<std::add_pointer_t<QuizResult>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (quizwindow::*)(const QuizResult & )>(_a, &quizwindow::quizFinished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (quizwindow::*)()>(_a, &quizwindow::backRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void quizwindow::quizFinished(const QuizResult & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void quizwindow::backRequested()
{

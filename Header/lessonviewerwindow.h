...
class lessonviewerwindow : public QWidget
{
    Q_OBJECT
public:
    explicit lessonviewerwindow(int courseId, const QString& courseTitle, const QString& username, QWidget* parent = nullptr);
    ~lessonviewerwindow();

signals:
    void backRequested();
    void allLessonsComplete(int courseId, const QString& courseTitle);

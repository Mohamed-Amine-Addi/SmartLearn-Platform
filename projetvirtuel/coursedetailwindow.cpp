...
coursedetailwindow::coursedetailwindow(const course& c,
    ...
    , m_username(username)
{
    ...
    ui->label_lang_badge->setStyleSheet(
        c.language == "C++"
        ? "QLabel{background:#0d1f5c;border-radius:12px;"
          "border:1px solid #1a3a99;color:#93c5fd;"
          "font-size:13px;font-weight:bold;}"
        : "QLabel{background:#1a0a40;border-radius:12px;"
          "border:1px solid #3b1a99;color:#c4b5fd;"
          "font-size:13px;font-weight:bold;}");

    // Difficulty badge
    ui->label_difficulty_badge->setText(c.difficultytext());
    ui->label_difficulty_badge->setStyleSheet(QString(
        "QLabel{color:%1;border:1px solid %1;"
